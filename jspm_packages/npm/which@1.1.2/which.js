...
(function(process) {
  ...
  if (isWindows) {
    ...
    isExe = function isExe(mod, uid, gid) {
      var ret = (mod & 1) || (mod & U) && process.getgid && gid === process.getgid() || (mod & G) && process.getuid && uid === process.getuid() || (mod & UG) && process.getuid && 0 === process.getuid();
    ...
    (function F(i, l) {
      ...
      (function E(ii, ll) {
        ...
        fs.stat(p + ext, function(er, stat) {
          if (!er && stat.isFile() && isExe(stat.mode, stat.uid, stat.gid)) {
