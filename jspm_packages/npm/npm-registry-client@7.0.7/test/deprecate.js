...
test('deprecate call contract', function(t) {
  ...
  t.throws(function() {
    ...
    name: 'AssertionError',
    message: 'must pass version to deprecate'
  ...
  t.throws(function() {
    ...
    name: 'AssertionError',
    message: 'must pass message to deprecate'
  ...
  t.throws(function() {
    ...
    name: 'AssertionError',
    message: 'must pass auth to deprecate'
  ...
  t.test('malformed semver in deprecation', function(t) {
    ...
    client.deprecate(URI, params, function(err) {
      t.equal(err && err.message, 'invalid version range: -9001', 'got expected semver validation failure');
      t.end();
    });
  });
  t.end();
...
test('deprecate a package', function(t) {
  ...
  server.expect('PUT', '/underscore', function(req, res) {
    ...
    req.on('end', function() {
      ...
      var undeprecated = ['1.0.3', '1.0.4', '1.1.0', '1.1.1', '1.1.2', '1.1.3', '1.1.4', '1.1.5', '1.1.6', '1.1.7', '1.2.0', '1.2.1', '1.2.2', '1.2.3', '1.2.4', '1.3.0', '1.3.1', '1.3.3'];
  ...
  client.deprecate(common.registry + '/underscore', PARAMS, function(er, data) {
    t.ifError(er);
...
test('deprecate a scoped package', function(t) {
  ...
  client.deprecate(common.registry + '/@test%2funderscore', PARAMS, function(er, data) {
    t.ifError(er);
    t.ok(data.deprecated, 'was deprecated');
    t.end();
  });
