...
test('publish call contract', function(t) {
  ...
  t.throws(function() {
    ...
    name: 'AssertionError',
    message: 'must pass package metadata to publish'
  ...
  t.throws(function() {
    ...
    name: 'AssertionError',
    message: 'must pass package body to publish'
  ...
  t.throws(function() {
    ...
    name: 'AssertionError',
    message: 'must pass auth to publish'
  ...
  t.test('malformed semver in publish', function(t) {
    ...
    client.publish(URI, params, function(err) {
      t.equal(err && err.message, 'invalid semver: %!@#$', 'got expected semver validation failure');
      t.end();
    });
  });
  t.end();
