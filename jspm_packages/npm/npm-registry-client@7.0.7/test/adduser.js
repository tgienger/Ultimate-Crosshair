...
test('adduser call contract', function(t) {
  ...
  t.throws(function() {
    ...
    name: 'AssertionError',
    message: 'must include username in auth'
  ...
  t.throws(function() {
    ...
    name: 'AssertionError',
    message: 'must include password in auth'
  ...
  t.throws(function() {
    ...
    name: 'AssertionError',
    message: 'must include email in auth'
  ...
  t.test('password missing', function(t) {
    ...
    client.adduser(URI, params, function(err) {
      t.equal(err && err.message, 'No password supplied.', 'password must not be empty');
      t.end();
    });
  });
  t.test('email missing', function(t) {
    ...
    client.adduser(URI, params, function(err) {
      t.equal(err && err.message, 'No email address supplied.', 'email must not be empty');
      t.end();
    });
  });
  t.test('email malformed', function(t) {
    ...
    client.adduser(URI, params, function(err) {
      t.equal(err && err.message, 'Please use a real email address.', 'email must look like email');
      t.end();
    });
  });
  t.end();
