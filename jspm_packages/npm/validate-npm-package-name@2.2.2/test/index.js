...
test("validate-npm-package-name", function(t) {
  t.deepEqual(validate("some-package"), {
    validForNewPackages: true,
    validForOldPackages: true
  });
  t.deepEqual(validate("example.com"), {
    validForNewPackages: true,
    validForOldPackages: true
  });
  t.deepEqual(validate("under_score"), {
    validForNewPackages: true,
    validForOldPackages: true
  });
  t.deepEqual(validate("period.js"), {
    validForNewPackages: true,
    validForOldPackages: true
  });
  t.deepEqual(validate("123numeric"), {
    validForNewPackages: true,
    validForOldPackages: true
  });
