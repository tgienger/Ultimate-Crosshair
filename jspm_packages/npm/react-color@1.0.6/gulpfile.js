...
(function(process) {
  ...
  gulp.task('build', function(done) {
    ...
    build.plugins = [new webpack.DefinePlugin({'process.env': {NODE_ENV: JSON.stringify('production')}}), new webpack.optimize.DedupePlugin()];
  ...
  gulp.task('bundle', function(done) {
    return gulp.src('./src/**/*').pipe(modify({fileModifier: function(file, contents) {
        return mapStyles(contents);
      }})).pipe(babel()).pipe(gulp.dest('lib'));
  });
  gulp.task('bundle-material', function(done) {
    return gulp.src('./modules/react-material-design/src/**/*').pipe(modify({fileModifier: function(file, contents) {
        return mapStyles(contents);
      }})).pipe(babel()).pipe(gulp.dest('./modules/react-material-design/lib'));
  });
  gulp.task('bundle-docs', function(done) {
    return gulp.src('./modules/react-docs/src/**/*').pipe(modify({fileModifier: function(file, contents) {
        return mapStyles(contents);
      }})).pipe(babel()).pipe(gulp.dest('./modules/react-docs/lib'));
  });
  gulp.task('bundle-layout', function(done) {
    return gulp.src('./modules/react-basic-layout/src/**/*').pipe(modify({fileModifier: function(file, contents) {
        return mapStyles(contents);
      }})).pipe(babel()).pipe(gulp.dest('./modules/react-basic-layout/lib'));
  });
  gulp.task('bundle-move', function(done) {
    return gulp.src('./modules/react-move/src/**/*').pipe(modify({fileModifier: function(file, contents) {
        return mapStyles(contents);
