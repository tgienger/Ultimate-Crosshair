  ...
  _createClass(SidebarItem, [{
    ...
    value: function classes() {
      return {
        ...
        'active': {sidebarItem: {color: this.props.primaryColor}}
      };
    }
  }, {
    key: 'render',
    value: function render() {
      return React.createElement('div', {style: this.styles().li}, React.createElement(Tile, {condensed: true}, React.createElement('div', {style: this.styles().number}, this.props.sidebarNumber), React.createElement('a', {
