    ...
    value: function render() {
      ...
      for (var fileName in this.props.files) {
        if (this.props.files.hasOwnProperty(fileName)) {
          ...
          sidebarItems.push(React.createElement(SidebarItem, {
            key: fileName,
      ...
      return React.createElement('div', {style: this.styles().sidebar}, React.createElement('div', {style: this.styles().star}, this.props.bottom), sidebarItems);
    }
  }]);
  return Sidebar;
})(ReactCSS.Component);
