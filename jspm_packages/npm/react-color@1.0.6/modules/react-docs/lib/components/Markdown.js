  ...
  _createClass(Markdown, [{
    ...
    value: function render() {
      ...
      for (var i = 0; i < markdown.isCode(children).length; i++) {
        ...
        codes[i] = React.createElement(Code, {
          file: codeBlock[2],
      ...
      for (var i = 0; i < newLines.split('\n').length; i++) {
        ...
        if (markdown.isCodeBlock(line)) {
          markdownFile.push(React.createElement('div', {key: i}, codes[markdown.codeNumber(line)]));
        } else {
          markdownFile.push(React.createElement('div', {
            key: i,
      ...
      return React.createElement('div', {style: this.styles().markdown}, markdownFile);
    }
  }]);
  return Markdown;
})(ReactCSS.Component);
