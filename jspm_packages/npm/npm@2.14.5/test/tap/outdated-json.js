...
(function(process) {
  ...
  test('setup', function(t) {
    ...
    mr({port: common.port}, function(er, s) {
      ...
      server = s;
      common.npm(['--registry', common.registry, '--silent', 'install'], EXEC_OPTS, function(err, code) {
  ...
  test('it should log json data', function(t) {
    common.npm(['--registry', common.registry, '--silent', '--json', 'outdated'], EXEC_OPTS, function(err, code, stdout) {
