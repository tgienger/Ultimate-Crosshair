...
(function(process) {
  ...
  var json = {
    ...
    version: '0.0.0',
    dependencies: {'private': 'git+https://user:pass@bitbucket.org/foo/private.git'}
  };
  ...
  test('bitbucket-https-url-with-creds-package', function(t) {
    var cloneUrls = [['https://user:pass@bitbucket.org/foo/private.git', 'Bitbucket URLs with passwords try only that.']];
