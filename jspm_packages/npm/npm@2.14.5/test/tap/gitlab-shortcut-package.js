...
(function(process) {
  ...
  var json = {
    ...
    version: '0.0.0',
    dependencies: {'private': 'gitlab:foo/private'}
  };
  ...
  test('gitlab-shortcut-package', function(t) {
    var cloneUrls = [['git@gitlab.com:foo/private.git', 'GitLab shortcuts try SSH first'], ['https://gitlab.com/foo/private.git', 'GitLab shortcuts try HTTPS URLs second']];
