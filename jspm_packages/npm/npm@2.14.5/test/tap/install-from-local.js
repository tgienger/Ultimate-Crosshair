...
(function(process) {
  ...
  var localPaths = {
    ...
    version: '0.0.0',
    dependencies: {'package-local-dependency': 'file:../package-local-dependency'},
    devDependencies: {'package-local-dev-dependency': 'file:../package-local-dev-dependency'}
  };
  var localDependency = {
  ...
  test('setup', function(t) {
    rimraf.sync(pkg);
    mkdirp.sync(pkg);
    fs.writeFileSync(path.join(pkg, 'package.json'), JSON.stringify(localPaths, null, 2));
