...
function mocks(server) {
  server.get("/-/user/org.couchdb.user:othiym23").many().reply(200, othiym23);
  server.get("/underscore").reply(200, {
    _id: "underscore",
    _rev: 1,
    maintainers: [jashkenas]
  });
  server.put("/underscore/-rev/1", {
    _id: "underscore",
    _rev: 1,
    maintainers: [jashkenas, othiym23]
  }, {}).reply(200, {
    _id: "underscore",
    _rev: 2,
    maintainers: [jashkenas, othiym23]
  });
  server.get("/@xxx%2fscoped").reply(200, {
    _id: "@xxx/scoped",
    _rev: 1,
    maintainers: [bcoe]
  });
  server.put("/@xxx%2fscoped/-rev/1", {
    _id: "@xxx/scoped",
    _rev: 1,
    maintainers: [bcoe, othiym23]
  }, {}).reply(200, {
    _id: "@xxx/scoped",
    _rev: 2,
    maintainers: [bcoe, othiym23]
...
test("setup", function(t) {
  common.npm(["--loglevel", "silent", "cache", "clean"], EXEC_OPTS, function(err, code) {
...
test("npm owner add", function(t) {
  common.npm(["--loglevel", "silent", "--registry", common.registry, "owner", "add", "othiym23", "underscore"], EXEC_OPTS, function(err, code, stdout, stderr) {
...
test("npm owner add (scoped)", function(t) {
  common.npm(["--loglevel", "silent", "--registry", common.registry, "owner", "add", "othiym23", "@xxx/scoped"], EXEC_OPTS, function(err, code, stdout, stderr) {
...
test("npm owner ls", function(t) {
  common.npm(["--loglevel", "silent", "--registry", common.registry, "owner", "ls", "underscore"], EXEC_OPTS, function(err, code, stdout, stderr) {
...
test("npm owner rm", function(t) {
  common.npm(["--loglevel", "silent", "--registry", common.registry, "owner", "rm", "othiym23", "underscore"], EXEC_OPTS, function(err, code, stdout, stderr) {
