...
(function(process) {
  ...
  var json = {
    ...
    scripts: {foo: 'foo --title \"Analysis of\" --recurse -d report src'},
    dependencies: {'scripts-whitespace-windows-dep': '0.0.1'},
    license: 'WTFPL'
  };
  var dependency = {
  ...
  test('setup', function(t) {
    ...
    fs.writeFileSync(path.join(pkg, 'README.md'), "### THAT'S RIGHT\n");
