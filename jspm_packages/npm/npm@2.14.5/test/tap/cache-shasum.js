...
(function(process) {
  ...
  test("npm cache add request", function(t) {
    var c = spawn(process.execPath, [npm, "cache", "add", "request@2.27.0", "--cache=" + cache, "--registry=" + common.registry, "--loglevel=quiet"]);
  ...
  test("compare", function(t) {
    ...
    var r = require("./cache-shasum/localhost_1337/request/.cache.json!systemjs-json");
