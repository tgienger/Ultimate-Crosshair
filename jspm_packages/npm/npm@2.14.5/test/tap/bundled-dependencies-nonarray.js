...
(function(process) {
  ...
  var pj = JSON.stringify({
    ...
    version: '1.0.0',
    dependencies: {'a-bundled-dep': 'file:../a-bundled-dep'},
    bundledDependencies: {'a-bundled-dep': 'file:../a-bundled-dep'}
  }, null, 2) + '\n';
  ...
  test('errors on non-array bundleddependencies', function(t) {
    ...
    npm.load({}, function() {
      common.npm(['install'], {cwd: pkg}, function(err, code, stdout, stderr) {
        ...
        common.npm(['install', './pkg-with-bundled'], {cwd: dir}, function(err, code, stdout, stderr) {
          t.ifError(err, 'npm install ran without issue');
