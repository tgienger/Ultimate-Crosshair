...
(function(process) {
  ...
  test('setup', function(t) {
    ...
    mr({port: common.port}, function(er, s) {
      common.npm(['--registry', common.registry, 'install', 'underscore@1.3.1', 'mkdirp', 'test-package-with-one-dep'], EXEC_OPTS, function(er, c) {
  ...
  test('npm ls --depth=0', function(t) {
    common.npm(['ls', '--depth=0'], EXEC_OPTS, function(er, c, out) {
      t.ifError(er, 'setup installation ran without issue');
  ...
  test('npm ls --depth=1', function(t) {
    common.npm(['ls', '--depth=1'], EXEC_OPTS, function(er, c, out) {
      t.ifError(er, 'setup installation ran without issue');
      t.equal(c, 1, 'ls barfed');
      t.has(out, /UNMET DEPENDENCY optimist@0\.6\.0/, 'output contains optimist@0.6.0 and labeled as unmet dependency');
      t.has(out, /mkdirp@0\.3\.5 extraneous/, 'output contains mkdirp@0.3.5 and labeled as extraneous');
  ...
  test('npm ls --depth=Infinity', function(t) {
    common.npm(['ls', '--depth=Infinity'], EXEC_OPTS, function(er, c, out) {
      t.ifError(er, 'setup installation ran without issue');
      t.equal(c, 1, 'ls barfed');
      t.has(out, /UNMET DEPENDENCY optimist@0\.6\.0/, 'output contains optimist@0.6.0 and labeled as unmet dependency');
      t.has(out, /mkdirp@0\.3\.5 extraneous/, 'output contains mkdirp@0.3.5 and labeled as extraneous');
