...
(function(process) {
  ...
  test('it should not throw', function(t) {
    var output = [];
    var expOut = [path.resolve(pkg, 'node_modules', 'async') + ':async@0.2.9' + ':async@0.2.9' + ':async@0.2.10' + '\n' + path.resolve(pkg, 'node_modules', 'checker') + ':checker@0.5.1' + ':checker@0.5.1' + ':checker@0.5.2' + '\n' + path.resolve(pkg, 'node_modules', 'underscore') + ':underscore@1.3.1' + ':underscore@1.3.1' + ':underscore@1.5.1'];
    var expData = [[pkg, 'async', '0.2.9', '0.2.9', '0.2.10', '0.2.9'], [pkg, 'checker', '0.5.1', '0.5.1', '0.5.2', '0.5.1'], [pkg, 'underscore', '1.3.1', '1.3.1', '1.5.1', '1.3.1']];
