...
(function(process) {
  ...
  test('#6311: npm ll --depth=0 duplicates listing', function(t) {
    common.npm(['--loglevel', 'silent', '--registry', common.registry, 'install', dep], EXEC_OPTS, function(err, code, stdout, stderr) {
      ...
      t.equal(stdout.trim(), 'glock@1.8.7 node_modules/glock\n└── underscore@1.5.1', 'got expected install output');
      common.npm(['--loglevel', 'silent', 'ls', '--long', '--depth', '0'], EXEC_OPTS, function(err, code, stdout, stderr) {
