...
var CONFS = {};
var DOC = {};
var exceptions = [path.resolve(lib, "adduser.js"), path.resolve(lib, "config.js"), path.resolve(lib, "publish.js"), path.resolve(lib, "utils", "lifecycle.js"), path.resolve(lib, "utils", "map-to-registry.js"), path.resolve(nm, "npm-registry-client", "lib", "publish.js"), path.resolve(nm, "npm-registry-client", "lib", "request.js")];
...
test("check configs", function(t) {
  var defs = require("../../lib/config/defaults");
