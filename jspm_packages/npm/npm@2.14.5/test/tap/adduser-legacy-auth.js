...
(function(Buffer) {
  ...
  function mocks(server) {
    ...
    server.put('/-/user/org.couchdb.user:u', 'auth').reply(409, {error: 'user exists'});
    server.get('/-/user/org.couchdb.user:u?write=true').reply(200, {_rev: '3-deadcafebabebeef'});
    server.put('/-/user/org.couchdb.user:u/-rev/3-deadcafebabebeef', 'auth', {authorization: 'Basic dTpw'}).reply(201, {
      username: 'u',
      password: 'p',
      email: 'u@p.me'
    });
