...
(function(process) {
  ...
  var pjParent = JSON.stringify({
    ...
    dependencies: {
      ...
      '@scoped/another-local-module': 'file:another-local-module',
      'underscore': 'file:underscore',
      'optimist': 'file:optimist'
    }
  }, null, 2) + '\n';
  ...
  function mocks(server) {
    server.get('/local-module').reply(404);
    server.get('/@scoped%2fanother-local-module').reply(404);
  }
