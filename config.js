System.config({
  ...
  map: {
    ...
    "npm:fs-write-stream-atomic@1.0.4": {
      "crypto": "github:jspm/nodelibs-crypto@0.1.0",
      "graceful-fs": "npm:graceful-fs@4.1.2",
      "process": "github:jspm/nodelibs-process@0.1.1",
      "util": "github:jspm/nodelibs-util@0.1.0"
    ...
    "npm:init-package-json@1.9.1": {
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "glob": "npm:glob@5.0.14",
      "npm-package-arg": "npm:npm-package-arg@4.0.2",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "promzard": "npm:promzard@0.3.0",
      "read": "npm:read@1.0.7",
      "read-package-json": "npm:read-package-json@2.0.1",
    ...
    "npm:npm@2.14.5": {
      ...
      "child_process": "github:jspm/nodelibs-child_process@0.1.0",
      "chmodr": "npm:chmodr@1.0.1",
      "chownr": "npm:chownr@1.0.1",
      "cmd-shim": "npm:cmd-shim@2.0.1",
      "columnify": "npm:columnify@1.5.2",
      ...
      "events": "github:jspm/nodelibs-events@0.1.1",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "fs-vacuum": "npm:fs-vacuum@1.2.7",
      "fs-write-stream-atomic": "npm:fs-write-stream-atomic@1.0.4",
      "fstream": "npm:fstream@1.0.8",
      "fstream-npm": "npm:fstream-npm@1.0.5",
      ...
      "inherits": "npm:inherits@2.0.1",
      "ini": "npm:ini@1.3.4",
      "init-package-json": "npm:init-package-json@1.9.1",
      ...
      "nopt": "npm:nopt@3.0.4",
      "normalize-git-url": "npm:normalize-git-url@3.0.1",
      "normalize-package-data": "npm:normalize-package-data@2.3.4",
      "npm-cache-filename": "npm:npm-cache-filename@1.0.2",
      "npm-install-checks": "npm:npm-install-checks@1.0.6",
      "npm-package-arg": "npm:npm-package-arg@4.0.2",
      "npm-registry-client": "npm:npm-registry-client@7.0.7",
      ...
      "read-package-json": "npm:read-package-json@2.0.1",
      "readable-stream": "npm:readable-stream@1.1.13",
      "realize-package-specifier": "npm:realize-package-specifier@3.0.1",
      "request": "npm:request@2.62.0",
      "retry": "npm:retry@0.8.0",
      "rimraf": "npm:rimraf@2.4.3",
      "semver": "npm:semver@5.0.3",
      "sha": "npm:sha@2.0.1",
      "slide": "npm:slide@1.1.6",
      "sorted-object": "npm:sorted-object@1.0.0",
      "spdx": "npm:spdx@0.4.1",
      "stream": "github:jspm/nodelibs-stream@0.1.0",
      "systemjs-json": "github:systemjs/plugin-json@0.1.0",
      "tar": "npm:tar@2.2.1",
      ...
      "which": "npm:which@1.1.2",
      "wrappy": "npm:wrappy@1.0.1",
      "write-file-atomic": "npm:write-file-atomic@1.1.3",
      "zlib": "github:jspm/nodelibs-zlib@0.1.0"
    },
    "npm:npmlog@1.2.1": {
      "ansi": "npm:ansi@0.3.0",
    ...
    "npm:react-color@1.0.6": {
      "install": "npm:install@0.1.8",
      "lodash": "npm:lodash@3.10.1",
      "material-colors": "npm:material-colors@1.0.0",
    ...
    "npm:realize-package-specifier@3.0.1": {
      "dezalgo": "npm:dezalgo@1.0.3",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "npm-package-arg": "npm:npm-package-arg@4.0.2",
      "path": "github:jspm/nodelibs-path@0.1.0"
    ...
    "npm:spdx-expression-parse@1.0.0": {
      "spdx-exceptions": "npm:spdx-exceptions@1.0.2",
      "spdx-license-ids": "npm:spdx-license-ids@1.0.2"
    },
